...
class CountlyConfigApm {
    ...
    get enableForegroundBackground() {
        return this._enableForegroundBackground;
    }

    get enableManualAppLoaded() {
        return this._enableManualAppLoaded;
    }

    get startTSOverride() {
        return this._startTSOverride;
    }

    get trackAppStartTime() {
        return this._trackAppStartTime;
    }
