declare module 'countly-sdk-react-native-bridge' {
  ...
  type FeedbackModule = {
    getAvailableFeedbackWidgets(onFinished: callback): string | Promise<string |[]>;
    presentFeedbackWidget(feedbackWidget: Object, closeButtonText: String, widgetShownCallback: callback, widgetClosedCallback: callback): string | Promise<string | void>;
    getFeedbackWidgetData(widgetInfo: Object, onFinished: callback): string | Promise<string | []>;
    reportFeedbackWidgetManually(widgetInfo: Object, widgetData: Object, widgetResult: Object): string | Promise<string>;
  };
